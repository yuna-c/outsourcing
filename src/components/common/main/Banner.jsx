...
const Banner = () => {
  ...
  return (
    <div className="!h-screen md:pt-10 pt-[4rem] !mt-2 bg-left-top bg-cover md:!h-[800px] saturate-50 bg-custom-deepblue bg-custom-main-gradient opacity-95 custom-main-gradient relative overflow-hidden bg-no-repeat flex flex-col justify-center items-center">
